      ...
      <div className="">
        ...
        <div class="grid md:grid-cols-3 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://www.thecookierookie.com/wp-content/uploads/2023/04/featured-stovetop-burgers-recipe-500x500.jpg" class="object-cover h-24 w-48"/>
            <p>Hambuger</p>
          </div>
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://senecuisine.com/wp-content/uploads/2020/09/thi%C3%A9bou-dieune.jpg" class="object-cover h-24 w-48"/>
            <p>Thiebou Dieune</p>
          </div>
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://cdn.chefclub.tools/uploads/recipes/cover-thumbnail/5a8725a0-d866-4917-9e91-d5a33f389c30_hEXYs5a.jpg" class="object-cover h-24 w-48"/>
            <p>Jus Citron</p>
          </div>
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://recette.supertoinette.com/155452/b/poulet-roti.jpg" class="object-cover h-24 w-48"/>
            <p>Poulet Rotie</p>
          </div>
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://cdn.chefclub.tools/uploads/recipes/cover-thumbnail/e8eda721-358c-4338-b406-801a7c8a2ddf_xWqVmdB.jpg" class="object-cover h-24 w-48"/>
            <p>Jus de fruits</p>
          </div>
          <div class="bg-zinc-200 rounded-md m-3 ">
            <img src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/dessert-main-image-molten-cake-0fbd4f2.jpg?resize=768,574" class="object-cover h-24 w-48"/>
            <p>Chocolat</p>
          </div>
